            ...
            while play_again.lower() == "yes":
                ...
                if msg.content == "1":        # make an if statement to determine which game the player wants to play
                    ...
                    while replay.lower() == "yes":            # while loop for replayability
                        ...
                        replay = await self.bot.wait_for('message', check=lambda message: message.author == ctx.author and message.channel == ctx.channel)
                    ...
                    while replay.lower() == "yes":     # while loop for replayability
                        ...
                        choice = await self.bot.wait_for('message', check=lambda message: message.author == ctx.author and message.channel == ctx.channel)
                ...
                play_again = await self.bot.wait_for('message', check=lambda message: message.author == ctx.author and message.channel == ctx.channel)
